...
export type FilePreviewFailure = FilePreviewNoWorkspace | FilePreviewNotFound | FilePreviewNotText | FilePreviewTooLarge | FilePreviewWriteDenied | FilePreviewIoFailure;
...
export type ListTreeResult = Ok<FileTreeNode[]> | Rejected<FilePreviewNoWorkspace | FilePreviewIoFailure>;
/** Read one UTF-8 text file. */
export type ReadFileResult = Ok<{
    path: string;
    content: string;
}> | Rejected<FilePreviewNotFound | FilePreviewNotText | FilePreviewTooLarge | FilePreviewIoFailure>;
/** Overwrite one text file. */
export type WriteFileResult = Ok<{
    path: string;
